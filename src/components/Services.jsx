  ...
  return (
    <div className="w-full h-[70vh] md:h-[120vh] flex items-center justify-center gap-x-9">
      ...
      <div className="space-y-9 text-xl md:text-2xl px-6 md:px-0 font-normal">
        <p>
          Elevante Labs is a cutting-edge tech{" "}
          <br className="hidden md:block" />
          agency specializing in full-stack <br className="hidden md:block" />
          development, cloud solutions, and <br className="hidden md:block" />
